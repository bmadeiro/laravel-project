...
class CrudViewCommand extends Command
{
     ...
     * @var string
     */
    protected $description = 'Create views for the project.';
    ...
    public function __construct()
    {
        ...
        $this->delimiter = config('generator.custom_delimiter')
            ? config('generator.custom_delimiter')
            : ['%%', '%%'];
    }
    ...
    public function handle()
    {
        ...
        $this->viewDirectoryPath = config('generator.custom_template')
            ? config('generator.path') . 'views/' . $formHelper . '/'
    ...
    {
        $dynamicViewTemplate = config('generator.dynamic_view_template')
            ? config('generator.dynamic_view_template')
